...
echo '<title>TorHost\'s Hosting - Dashboard</title>';
...
echo '<p>There is no Web-based file management yet, you\'ll need to use an FTP client like <a href="https://filezilla-project.org/">FileZilla</a> (<a href="http://torhostxjah7oso6.onion/tutorials/torify-ftp/" target="_blank">Torify FileZilla</a>) for now, to manage files. A web based file manager is planned.</p>';
echo '<h3>Domain</h3>';
echo '<table border="1">';
